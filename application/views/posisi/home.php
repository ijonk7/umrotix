...
<div class="box">
  <div class="box-header">
    ...
    <div class="col-md-2" style="padding: 0;">
      <button class="btn btn-danger konfirmasiHapus-posisiAll" data-toggle="modal" data-target="#konfirmasiHapusSemua"><i class="glyphicon glyphicon-remove-sign"></i> Delete All</button>
    </div>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
